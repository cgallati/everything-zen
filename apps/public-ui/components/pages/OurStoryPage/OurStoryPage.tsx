  ...
  return (
    <Page title={"our story"}>
      <Paragraph>
        ...
        needs to be shared. Above all, we value experiences with family and
        friends, and we know you do too.
      </Paragraph>
      <ImageSection
        src={friends3}
        alt=""
      ...
      <Paragraph>
        ...
        ones along the way are at the core of our chartering business. Our goal
        is to provide modern luxury that makes you feel safe and carefree while
        underway. This gives you peace-of-mind so you can turn your full
      ...
      <Paragraph>
        Captain Todd is licensed with the US Coast Guard with years of maritime
        experience sailing his large vessel catamarans. Both he and his wife,
        Kathy, have vast experience sailing and operating large vessels
        together. It has become a passion and a lifestyle, something they both
        love sharing with others.
      </Paragraph>
      <ImageSection
        src={friends5}
        alt=""
      ...
      <Paragraph>
        Join our story and climb aboard! Come be a part of an exclusive private
        sailing charter in the Charleston Harbor. The atmosphere our charter
        tour provides is a perfect setting for anything you&apos;re planning. We
        believe in accommodating our charter guests to maximize expectations,
        and hope you will reach out if you have any questions or concerns. Come
